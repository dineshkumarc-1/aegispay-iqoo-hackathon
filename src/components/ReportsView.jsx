...
`;
  ...
  return (
    <div className="space-y-4 pb-8 text-xs text-slate-800 font-sans leading-relaxed">
      ...
      <div className="p-3 bg-white border border-slate-200 rounded-2xl flex flex-wrap items-center justify-between gap-2 shadow-2xs">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-[11px] transition cursor-pointer flex items-center gap-1 active:scale-95 shadow-xs"
          >
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold text-[11px] transition cursor-pointer flex items-center gap-1 active:scale-95 shadow-xs"
          >
      ...
      {/* DPDP Act Audit & Pitch Deck Download Buttons */}
